...
void zachFit_roofit_compute(int fitType = 0, int ncpu=0) {
  ...
  //sigma^{rd}_i = sigma^{mc}_i * (1+epsilon) + deltaSigma_i = mc parameter *(1 + scale factor) + extra shift used in chi^2
  ...
  RooRealVar nmcg3("RD_nmcg3","",(1.0-MC_afrac.getVal()-MC_gfrac1.getVal()-MC_gfrac2.getVal())*nsig.getVal());
